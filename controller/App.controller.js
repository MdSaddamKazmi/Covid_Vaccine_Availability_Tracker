				...
				if (this.getView().byId("chknext").getSelected()) {
					...
					do {
						...
						if (oSegmentedButton === "pin") {
							...
							sPath = "https://cdn-api.co-vin.in/api/v4/appointment/sessions/public/calendarByPin?pincode=" + pincode + "&date=" +
								getDate(this, n);
						} else if (oSegmentedButton === "dis") {

							sPath = "https://cdn-api.co-vin.in/api/v4/appointment/sessions/public/calendarByDistrict?district_id=" + districtSelected +
								"&date=" +
								getDate(this, n);
						}
							...
							success: function (data) {
								...
								for (var i = 0; i < data.centers.length; i++) {
									...
									for (var j = 0; j < data.centers[i].sessions.length; j++) {
										...
										cntr.precaution_online_dose_one_available = data.centers[i].sessions[j].precaution_online_dose_one_available;
